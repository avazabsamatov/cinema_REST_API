...
import uz.pdp.cinema_rest_api.service.DistributorService;
...
public class DistributorController {
    ...
    public ResponseEntity<ApiResponse> getAllDistributors() {
        return new ResponseEntity<>(new ApiResponse(true, "successfully", distributorService.getAllDistributors()), HttpStatus.OK);
    }
    ...
    public ResponseEntity<ApiResponse> updateDistributor(@RequestPart("attachment") MultipartFile multipartFile,
        ...
        try {
            ...
            return new ResponseEntity<>(new ApiResponse(true, "edit", distributor), HttpStatus.OK);
        } catch (IOException ignored) {
        }
